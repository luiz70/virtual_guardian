...
$scope.menuAplicacion=false;
            $scope.abrefiltrosMenu=function(){
            if($rootScope.Usuario.IdSuscripcion>1)$scope.opcionMenu('filtros');
            else $scope.confirm($scope.idioma.general[11],$scope.idioma.general[12],function(){
