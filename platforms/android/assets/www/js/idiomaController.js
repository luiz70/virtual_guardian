...
36:"Salir"
            ...
            30:"Desseleccionar todo"
				...
				recorrido:{
					...
					6:'Mi ubicación',
					7:"En tu pantalla principal, te mostraremos un mapa con un punto azul representando tu ubicación y la zona que se esta escaneando, puedes mover el punto azul a otra zona para analizar otra región. Cuando el punto no se encuentre en tu ubicación actual, este cambiara a color gris.",
					8:"Radio personal",
					9:"El circulo azul alrededor de tu posisicion es el 'Radio de búsqueda' este te permite filtrar los eventos que pasen en una zona en especifico, se puede modificar en la barra de radio que esta en la parte inferior, para mostrarla completamente es necesario tocarla.",
					...
					14:"Para activar o desactivar el radio solo es necesario dar click en el circulo naranja que se encuentra en la barra de radio.",
					15:"Actualizar mapa",
					16:"Actualizar posicion",
					17:"Actualizar eventos",
					18:"Para reducir el consumo de datos móviles la aplicacion no actualiza frecuentemente tu ubicación, esta opcion te permitira actualizarla cuando tu desees para solo utilizar el internet cuando tu lo decidas.",
					19:"La aplicacion tampoco realiza busquedas frecuentes de los eventos, esta opcion te permitira tener siempre los eventos actualizados.",
					20:"Actualiza tu ubicación.",
					21:"Actualiza los eventos.",
					22:"Notificaciones",
					23:"En esta seccion podrás revisar todas las notificaciones que recibas para que siempre estes enterado de lo que pasa en tu país.",
					...
					27:'Alerta personal: Cuando un evento suceda cerca de ti, te lo notificaremos con este simbolo para que tomes precaución y no te expongas al peligro.',
					28:'Alerta auto: Cuando tu auto este en modo de vigilancia y un evento suceda cerca de el, te notificaremos para ayudarte a protegerlo.',
					29:'Alerta personas: Siempre que un evento suceda cerca de alguien que este en tu lista de personas te notificaremos para ayudarte a cuidarlo.',
					30:"Personas: Este tipo de notificaciones te informaran cuando alguien te envie o acepte una solicitud de personas.",
					31:"Personas",
					32:"En esta seccion podras agregar, aceptar o eliminar personas de tu lista, todas las personas que estén aqui recibiran notificaciones cuando algun evento de peligro suceda cerca de tí, de igual manera recibiras notificaciones de 'Alerta de personas' cuando algo suceda cerca de ellos. ",
					33:"Esta herramienta solo informa una distancia aproximada entre la persona y el evento mas no envia la ubicacion exacta para proteger la privacidad.",
					...
					40:'Para utilizar las funciones de esta herramienta primero es necesario ajustar la posicion de el auto en el mapa, después seleccionar la opcion de "Vigilar auto", esto te mostrara el analisis de la zona y te solicitara una confirmacion. Una vez confirmado, tu auto estara siendo cuidado por virtual guardian, la ubicación de tu auto se guardara en tu dispositivo móvil y en ningun momento se enviara a nuestros servidores, esto para proteger tu privacidad.',
					41:'Menú lateral',
					42:"Filtros",
					...
					45:"Esta seccion de configuracion te permite definir:",
					46:"Periodo: Cuando se realizan busquedas en el mapa, existen filtros generales que te permiten reducir la informacion segun tus preferencias, esta propiedad mostrará en el mapa los eventos que han sucedido en la ultima semana, mes, semestre o año.",
					47:"Radio: Esta propiedad te permite predefinir el radio del mapa principal, puedes modificarlo posteriormente en la barra de radio pero al cerrar la aplicacion se reestablece al especificado en esta opcion",
					48:"Ajustes de notificaciones",
					49:"En esta seccion te permitiremos personalizar las notificaciones para que solo recibas lo que te interesa, puedes configurar:",
					50:"Eventos: En esta opcion puedes desactivar las notificaciones de eventos, esto bloqueara las notificaciones de auto.",
					51:"Tiempo: Cuando un evento suceda antes de el tiempo especificado se te notificará, de lo contrario solo se mostrara en el mapa.",
					52:"Radio personal: Este es un parametro muy importante ya que te permite especificar la distancia a la que consideras que un evento puede ponerte en peligro, por lo tanto la aplicacion solo realizara alertas personales cuando te encuentres a una distancia menor a la especificada.",
					53:"Estados: En esta opcion puedes seleccionar los estados de los que te interesa recibir notificaciones, asi no te informaremos de lugares que no son relevantes para ti.",
					54:"Tipos de eventos: Al igual que la opcion anterior puedes selccionar los tipos de eventos que te interesan.",
					55:"Personas: En esta opcion puedes desactivar las notificaciones para no recibir alertas si algun evento sucede cerca de alguna de tus personas.",
					56:"Auto: En esta opcion puedes desactivar las notificaciones para no recibir alertas si algun evento sucede cerca de alguna de tu auto.",
					57:"Radio auto: Este es un parametro muy importante ya que te permite especificar la distancia a la que consideras que un evento puede poner a tu auto en peligro, por lo tanto la aplicacion solo realizara alertas de auto cuando se encuentre a una distancia menor a la especificada.",
					58:"Ajustes de cuenta",
					59:"Aqui puedes ver informacion relacionada con tu suscripcion, vigencia y cambiar tu contraseña.",
