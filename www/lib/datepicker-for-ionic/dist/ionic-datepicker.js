...
(function() {
  ...
  angular
  .module('ionic-datepicker')
  .service('DatepickerNls', function ($rootScope) {
    var nls = {
      'en-us': {
        weekdays: $rootScope.idioma.Semana,
        months: _.values($rootScope.idioma.Meses)
      },
      'pt-br': {
...
(function() {
  ...
  .service('DatepickerService', [ 'DatepickerNls', function (DatepickerNls) {
    ...
    this.getYears = function() {
      var years = [];
	  var d=new Date()
      for (var i = d.getFullYear(); i >= 2010 ; i--) years.push(i);
      return years;
    };
